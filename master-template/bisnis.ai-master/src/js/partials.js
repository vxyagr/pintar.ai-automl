(function($) {
    ...
    var global_functions = {
        ...
        module: function() {
            ...
            //edit data function//
            $('#edit-datasource').click(function(){
                $(this).hide();
                $('#overlay-data').hide();
                $('#prev-btn').show();
                $('#post-datasource').show();
            });
            ...
            //edit data function//
            $('#edit-preproc').click(function(){
                $(this).hide();
                $('#overlay-preproc').hide();
                $('#preprocess-action').show();
            });
            ...
            //edit data function//
            $('#edit-modeling').click(function(){
                $(this).hide();
                $('#overlay-modeling').hide();
                $('#modeling-action').show();
            });
